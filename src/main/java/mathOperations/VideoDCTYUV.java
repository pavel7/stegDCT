...
public class VideoDCTYUV implements Callable {
    private int sizeOfSegments = 8;
    private int firstElem = 0;
    private int lastElem = 0;
    private ArrayList<float[][][]> input = null;
    ...
    public VideoDCTYUV(ArrayList<float[][][]> inputList, int startElem, int endElem) {
        input = new ArrayList<>();
    ...
    public VideoDCTYUV(ArrayList<float[][][]> inputList, int startElem, int endElem, int newSizeOfSigments) {
        input = new ArrayList<>();
        for (int i = startElem; i < endElem; i++) {
            input.add(inputList.get(i).clone());
        }
    ...
    private ArrayList<double[][][]> calculateSpectrCoefOfDCT(ArrayList<float[][][]> listOfSegments) {
